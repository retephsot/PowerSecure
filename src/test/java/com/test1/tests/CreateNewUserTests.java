...
//  }
  ...
  public void testNewUserCreation(String username, String password, String email, String firstname,
		  String lastname, String companyname) throws InterruptedException 
  {
	...
	//The entry point LogInPage object below can now be removed because its added to TestBase can now inherit this
	 // LogInPage loginPage = new LogInPage(driver);
	  ...
	  boolean testResults = logInPage.loginAs(username, password)
			  						...
			  						.isCreateNewUserSuccessful(email);
